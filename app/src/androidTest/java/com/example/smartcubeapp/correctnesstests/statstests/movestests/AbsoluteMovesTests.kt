...
import com.example.smartcubeapp.stats.StatsDB
...
class AbsoluteMovesTests {
    ...
    fun bestAverageNumberOfMovesForCrossIn3Solves(){
        ...
        val result = statsService.bestAverageNumberOfMovesForPhaseInXSolves(3, SolvePhase.Cross)
        Assert.assertEquals(expectedValue, result, 0.01)
    }
    ...
    fun bestAverageNumberOfMovesForF2LIn5Solves(){
        ...
        val result = statsService.bestAverageNumberOfMovesForPhaseInXSolves(5, SolvePhase.F2L)
        Assert.assertEquals(expectedValue, result, 0.01)
    }
    ...
    fun bestAverageNumberOfMovesForOLLIn50Solves(){
        ...
        val result = statsService.bestAverageNumberOfMovesForPhaseInXSolves(50, SolvePhase.OLL)
        Assert.assertEquals(expectedValue, result, 0.01)
    }
    ...
    fun bestAverageNumberOfMovesForPLLIn500Solves(){
        ...
        val result = statsService.bestAverageNumberOfMovesForPhaseInXSolves(500, SolvePhase.PLL)
        Assert.assertEquals(expectedValue, result, 0.01)
    }
    ...
    fun bestAverageNumberOfMovesForPLLUaIn5Solves(){
        ...
        val result = statsService.bestAverageNumberOfMovesForPLLCaseInXSolves(5, PredefinedPLLCase.Ua)
        Assert.assertEquals(expectedValue, result, 0.01)
    }
    ...
    fun bestAverageNumberOfMovesForPLLHIn5Solves(){
        ...
        val result = statsService.bestAverageNumberOfMovesForPLLCaseInXSolves(5, PredefinedPLLCase.H)
        Assert.assertEquals(expectedValue, result, 0.01)
    }
    ...
    fun bestAverageNumberOfMovesForPLLEIn12Solves(){
        ...
        val result = statsService.bestAverageNumberOfMovesForPLLCaseInXSolves(12, PredefinedPLLCase.E)
        Assert.assertEquals(expectedValue, result, 0.01)
    }
    ...
    fun bestAverageNumberOfMovesForPLLJbIn50Solves(){
        ...
        val result = statsService.bestAverageNumberOfMovesForPLLCaseInXSolves(50, PredefinedPLLCase.Jb)
        Assert.assertEquals(expectedValue, result, 0.01)
    }
    ...
    fun bestAverageNumberOfMovesForOLL7In3Solves(){
        ...
        val result = statsService.bestAverageNumberOfMovesForOLLCaseInXSolves(3, PredefinedOLLCase.OLL_07)
        Assert.assertEquals(expectedValue, result, 0.01)
    }
    ...
    fun bestAverageNumberOfMovesForOLL24In5Solves(){
        ...
        val result = statsService.bestAverageNumberOfMovesForOLLCaseInXSolves(5, PredefinedOLLCase.OLL_24)
        Assert.assertEquals(expectedValue, result, 0.01)
    }
    ...
    fun bestAverageNumberOfMovesForOLL8In12Solves(){
        ...
        val result = statsService.bestAverageNumberOfMovesForOLLCaseInXSolves(12, PredefinedOLLCase.OLL_08)
        Assert.assertEquals(expectedValue, result, 0.01)
    }
    ...
    fun bestAverageNumberOfMovesForOLL4In50Solves(){
        ...
        val result = statsService.bestAverageNumberOfMovesForOLLCaseInXSolves(50, PredefinedOLLCase.OLL_04)
        Assert.assertEquals(expectedValue, result, 0.01)
    }
