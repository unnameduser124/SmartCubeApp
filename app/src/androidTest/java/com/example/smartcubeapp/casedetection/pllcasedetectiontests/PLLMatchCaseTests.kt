...
class PLLMatchCaseTests {
    ...
    fun matchCaseAaTest(){
        ...
        val case = pllCaseDetection.matchCase()
        if(case == null){
            fail()
        }
        else{
    ...
    fun matchCaseNbTest(){
        val cubeState = CubeState(
            ...
            mutableListOf(false, false, true, false, false, true, true, false, false, false, true, false)
        )
    ...
    fun matchCaseRbTest(){
        val cubeState = CubeState(
            ...
            mutableListOf(true, false, false, false, false, false, false, false, false, false, false, false)
        )
