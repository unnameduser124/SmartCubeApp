...
class SolutionPhaseDetection(private val solution: Solve, private val phaseDetection: CubeStatePhaseDetection) {
    ...
    fun getPhaseDurationInSeconds(phase: SolvePhase, context: Context): Double{
        val durationInMillis = getEndTimeForPhase(phase, context) - getStartTimeForPhase(phase, context)
        return durationInMillis.toDouble() / MILLIS_IN_SECOND
    }

    fun getPhaseMoveCount(phase: SolvePhase): Int{
        TODO("Not implemented yet")
    }

    fun getPhaseTPS(phase: SolvePhase): Double{
        TODO("Not implemented yet")
    }
