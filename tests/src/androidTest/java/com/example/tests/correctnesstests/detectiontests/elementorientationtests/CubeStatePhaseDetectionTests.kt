...
class CubeStatePhaseDetectionTests {
    ...
    fun stateCrossSolvedWhiteSideTest() {
        ...
        assert(phase == com.example.cube_detection.phasedetection.SolvePhase.Cross)
    }
    ...
    fun stateF2LSolvedYellowSideTest() {
        ...
        cubeStatePhaseDetection.changeState(cubeState)
        val phase = cubeStatePhaseDetection.getFinishedPhaseForState(context)
        assert(phase == com.example.cube_detection.phasedetection.SolvePhase.F2L)
    }
    ...
    fun stateOLLSolvedOrangeSideTest() {
        ...
        cubeStatePhaseDetection.changeState(cubeState)
        val phase = cubeStatePhaseDetection.getFinishedPhaseForState(context)
        assert(phase == com.example.cube_detection.phasedetection.SolvePhase.OLL)
    }
    ...
    fun stateCubeSolvedTest() {
        ...
        val phase = cubeStatePhaseDetection.getFinishedPhaseForState(context)
        assert(phase == com.example.cube_detection.phasedetection.SolvePhase.PLL)
    }
