package com.example.cube_database.solvedatabase.statsDB
        ...
        with(cursor){
            if(moveToFirst()){
                val bestSolve = SolveData(
                    ...
                    solveDuration = getLong(getColumnIndexOrThrow(com.example.cube_database.solvedatabase.solvesDB.SolvesDatabaseConstants.SolveTable.DURATION_COLUMN)),
                    timestamp = getLong(getColumnIndexOrThrow(com.example.cube_database.solvedatabase.solvesDB.SolvesDatabaseConstants.SolveTable.TIMESTAMP_COLUMN)),
                    scrambledStateID = getLong(getColumnIndexOrThrow(com.example.cube_database.solvedatabase.solvesDB.SolvesDatabaseConstants.SolveTable.SCRAMBLED_STATE_ID_COLUMN)),
                    scramble = getString(getColumnIndexOrThrow(com.example.cube_database.solvedatabase.solvesDB.SolvesDatabaseConstants.SolveTable.SCRAMBLE_SEQUENCE_COLUMN)),
                    moveCount = getInt(getColumnIndexOrThrow(com.example.cube_database.solvedatabase.solvesDB.SolvesDatabaseConstants.SolveTable.MOVE_COUNT))
                )
                close()
                return bestSolve
            }
