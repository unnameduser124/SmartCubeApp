        ...
        with(cursor) {
            if (moveToFirst()) {
                ...
                val lastConnectionMillis =
                    getLong(getColumnIndexOrThrow(com.example.cube_database.solvedatabase.solvesDB.SolvesDatabaseConstants.DeviceTable.LAST_CONNECTION_TIME_COLUMN))
    ...
    fun getAllDevices(): List<CubeDevice>{
        ...
        with(cursor){
            while(moveToNext()){
                ...
                val name = getString(getColumnIndexOrThrow(com.example.cube_database.solvedatabase.solvesDB.SolvesDatabaseConstants.DeviceTable.DEVICE_NAME_COLUMN))
                val address = getString(getColumnIndexOrThrow(com.example.cube_database.solvedatabase.solvesDB.SolvesDatabaseConstants.DeviceTable.DEVICE_ADDRESS_COLUMN))
                val lastConnectionMillis = getLong(getColumnIndexOrThrow(com.example.cube_database.solvedatabase.solvesDB.SolvesDatabaseConstants.DeviceTable.LAST_CONNECTION_TIME_COLUMN))
